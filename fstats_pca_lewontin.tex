...
About 15\% of genetic variation in humans can be explained by population structure \cite{lewontin1972, barbujani1997, rosenberg2003, mallick2016}, but the information contained in these 15\% is sufficient to study our genetic diversity and history in great detail \cite{cavalli-sforza1994, stoneking2016, reich2018}. Direct-to-consumer-genetics companies are using this variation to model the ancestry of millions of customers, and for some data sets, it is possible to predict an individuals' place of origin at a resolution of a few hundred kilometers \cite{novembre2008, leslie2015}.

Human genetic structure is also not particularly discrete. 
