...
\subsubsection{cost of simplificatio}

However, these simplification do come at a cost, both in terms of model violations that may invalidate statistical results, and in terms of excluding people that do not rigidly fall into predefined genetic groups. By framing admixture in the continuous context of PCA, the approach developed here shows one way how this trade-off between interpretability and accuracy can be mitigated.
